...
CREATE TABLE IF NOT EXISTS Users (
    id         BIGINT AUTO_INCREMENT PRIMARY KEY, -- 내부적으로 사용하는 사용자 고유 ID
...
-- 1. 사용자 데이터 삽입
INSERT INTO Users (id, kakao_id, username, user_password, email, provider, nickname, age_range, gender, llm_thread_id) VALUES
(1, 123456789, 'kimchulsoo', 'hashed_password_1', 'chulsoo@example.com', 'LOCAL', '철수', '20-29', 'male', 'thread_001'),
(2, 987654321, 'leeyounghee', 'hashed_password_2', 'younghee@example.com', 'KAKAO', '영희', '30-39', 'female', 'thread_002'),
(3, NULL, 'john_doe', 'hashed_password_3', 'johndoe@example.com', 'LOCAL', 'John', '40-49', 'male', 'thread_003'),
(4, 112233445, 'alice123', 'hashed_password_4', 'alice@example.com', 'KAKAO', 'Alice', '20-29', 'female', 'thread_004');
...
-- 3. 사용자가 찜한 빵집 데이터 삽입
INSERT INTO FavoriteBakery (id, bakery_id, name) VALUES
(1, 101, '맛있는 빵집'),         -- 김철수가 '맛있는 빵집' 찜
(1, 102, '고소한 베이커리'),     -- 김철수가 '고소한 베이커리' 찜
(2, 103, '바삭한 크루아상'),     -- 이영희가 '바삭한 크루아상' 찜
(2, 105, '옛날 찹쌀 도넛'),     -- 이영희가 '옛날 찹쌀 도넛' 찜
(3, 104, '달콤한 케이크 하우스'), -- John이 '달콤한 케이크 하우스' 찜
(4, 101, '맛있는 빵집'),         -- Alice가 '맛있는 빵집' 찜
(4, 103, '바삭한 크루아상'),     -- Alice가 '바삭한 크루아상' 찜
(4, 105, '옛날 찹쌀 도넛');     -- Alice가 '옛날 찹쌀 도넛' 찜
